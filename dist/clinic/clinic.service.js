...
let ClinicService = class ClinicService {
    ...
    async getClinic(id) {
        ...
        return (0, clinic_response_1.ClinicResponse)(200, clinic, 'berhashil mendapatkan data');
    }
    ...
    async changePassword(req, dto) {
        ...
        console.log(...oo_oo(`724347610_81_4_81_24_4`, payload));
        ...
        console.log(...oo_oo(`724347610_91_4_91_26_4`, pwMatches));
        if (!pwMatches) {
            return new common_1.ForbiddenException('password lama salah');
        }
    ...
    async createNewDoctor(req, dto) {
        ...
        console.log(...oo_oo(`724347610_225_4_225_25_4`, idClinic));
